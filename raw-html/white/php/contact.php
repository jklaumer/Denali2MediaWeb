<?php
/** 
 * The back-end PHP file for the contact form.
 * Edit contact form settings in php/contact-config.php and js/settings.js
 * Do not edit this file unless you know what you're doing.
 *
 * Theme: Raw HTML
 */

if(trim($_POST['udt_contact_honeypot']) != '') {
	die('Sorry, the form was not submitted as you don\'t seem to be a human.');
}
